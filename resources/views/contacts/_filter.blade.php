            ...
            <div class="row">
                <div class="col">
                    <select id="filter_company_id" name="company_id" class="custom-select">
                        @include('contacts._companies_options')
                    </select>
                </div>
                <div class="col">
                    <div class="input-group mb-3">
                        <input type="text" id="search_txt" name="search" value="{{request('search')}}" class="form-control" placeholder="Search..." aria-label="Search..."
